...
def bar_graph_system_peak_grouped(data,restriction,configurations):
    ...
    with plt.style.context(["ctleelab_plothelper.base", "ctleelab_plothelper.light"]):
        ...
        plt.savefig(f"new{restriction}.png")
...
for composition in lipid_comp:
    ...
    for configuration in configurations: 
        ...
        for restriction in restrictions: 
            ...
            #storing per frame array, to look at convergenxe
...
#     # plt.savefig(
#     #     f"frame-defect-coverage-{configuration}-entire-restriction{restriction}-PS-ext.png",
#     #     dpi=300
#     # )
...
#     #bins_above50 = np.array([50, 400])
#     bins_above50 = np.arange(50, 450, 25)
